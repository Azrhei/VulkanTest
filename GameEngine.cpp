...
namespace GameEngine {
    ...
    GameEngine::QueueFamilyIndices GameEngine::findQueueFamilies(VkPhysicalDevice device)
    {
        struct GameEngine::QueueFamilyIndices indices;
    ...
    vector<const char*> GameEngine::getRequiredExtensions() {
    ...
    {
        //    static GameEngine __instance__;
    ...
    void GameEngine::cleanUpGLFW()
    {
        cleanUpWindow();
        glfwTerminate();
    }

    void GameEngine::cleanUpWindow()
    {
        glfwDestroyWindow(window);
    }

    void GameEngine::cleanUpVulkan()
    {
